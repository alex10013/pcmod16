...
net.Receive( 'programyolla', function()
entoku = net.ReadEntity()
tablooku = net.ReadTable()
entoku.Programlar = tablooku
end)
...
function DEV:Initialize( x, y, w, h )
	...
	bunubelirle = self.Entity.Programlar
	else
	bunubelirle = entoku.Programlar
	end
	
	for k, v in pairs( bunubelirle ) do
