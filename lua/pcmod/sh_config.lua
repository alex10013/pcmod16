...
cfg.TimedMessage 		= 	false -- Show a timed message advertising PCMod?
...
if (SERVER) then -- Security, dont want clients to somehow access this
	cfg.DbgPass			=	"pcm1337" -- Password to retrieve server-side debugging as a client
end -- Do not edit

--[[ BROKEN BROKEN BROKEN BROKEN BROKEN
NO SERIOUSLY, THIS IS BROOOOKKKEEEEENNNN ]]--
...
cfg.MaxNetworkPid = 250 -- What's the maximum amount pid through in one go?
...
cfg.WireTypes[ 7 ] = { Name="cat5e",	ExtName="CAT5-E Ethernet",	SameType=false } -- Category 5-E Ethernet Cable (Custom Router -> Tower)
