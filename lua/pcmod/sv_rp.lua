...
net.Receive( "Nope", function()
    local plyname = net.ReadEntity()
	DarkRP.notify( plyname, 1, 5, "You need to be a PC Technician to open the Buy Menu!" )
end)