...
function SWEP:TraceHitTower( tr )
	return ((!tr.HitWorld) && (tr.Entity) && (tr.Entity:IsValid()) && (tr.Entity.IsPCMod) && (tr.Entity.Class == "pcmod_tower" or "pcmod_laptop") && ((tr.HitPos-self.Owner:GetPos()):Length()<128))
end
...
function SWEP:DrawHUD()
	...
	if (self.Cracking) then
		...
		if (show) then draw.SimpleText( "CRACKING", "Default", w*0.5, (h*0.5)+(th*0.5), Color( 255, 255, 255, 255 ), 1, 1 ) end
	end
end
