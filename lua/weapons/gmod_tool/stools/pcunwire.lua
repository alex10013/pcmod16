...
if ((CLIENT) && (!ToolOnly)) then
	...
	language.Add( 'tool.pcunwire.name', 'Unwire Tool' )
	language.Add( 'tool.pcunwire.desc', 'Unconnects two ports.' )
	language.Add( 'tool.pcunwire.0', 'Left-Click: Select the primary device.' )
