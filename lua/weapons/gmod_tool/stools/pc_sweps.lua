...
if (CLIENT) then
	...
	language.Add( 'tool.pc_sweps.name', 'Swep Tool' )
	language.Add( 'tool.pc_sweps.desc', 'Gives you Sweps from PCMod 2' )
	language.Add( 'tool.pc_sweps.0', 'Left-Click: Give the swep' )
